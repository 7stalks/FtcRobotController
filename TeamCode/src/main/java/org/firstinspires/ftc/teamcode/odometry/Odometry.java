...
public class Odometry {
    ...
    final public double robotEncoderWheelDistance = 16.9; //Double.parseDouble(ReadWriteFile.readFile(wheelBaseSeparationFile).trim());// * calibration.encoderCountsPerIn;
