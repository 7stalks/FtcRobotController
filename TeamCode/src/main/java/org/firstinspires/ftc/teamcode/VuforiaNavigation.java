...
public class VuforiaNavigation {
    ...
    public void navigationInit(RobotHardware robot) {
        ...
        // TODO CHANGE
        final float CAMERA_FORWARD_DISPLACEMENT  = 0 * mmPerInch;   // eg: Camera is 8.5 Inches behind of robot-center
        final float CAMERA_VERTICAL_DISPLACEMENT = 5.0f * mmPerInch;   // eg: Camera is 5 Inches above ground
    ...
    public void navigation(Telemetry telemetry) {
        ...
        targetVisible = false;
        telemetry.addData("length", allTrackables.size());
        for (VuforiaTrackable trackable : allTrackables) {
